...
DOWNLOAD_SHUGIIN_MEETING = True
DOWNLOAD_SHUGIIN_MEMBERS = True
DOWNLOAD_SHUGIIN_RIPPOU = True
DOWNLOAD_SHUGIIN_SHUISHO = True
DOWNLOAD_SANGIIN_MEETING = True
DOWNLOAD_SANGIIN_MEMBERS = True
DOWNLOAD_SANGIIN_RIPPOU = True
